...
$input - disabled - bg:                 lighten($body - bg, 50 %);
$input - color:                       darken($input - disabled - bg, 50 %);
...
// ListView Web Component Styles
$list - group - action - color:           $body - color;
$list - group - bg:                     $body - bg;
$list - group - hover - bg:               lighten($body - bg, 2 %);
$list - group - action - active - bg:       lighten($body - bg, 4 %);
